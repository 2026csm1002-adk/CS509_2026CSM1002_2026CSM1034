...
- Language: C++17
- Compiler: g++ Apple clang version 21.0.0 
...
| int | bfs_50000.txt | Unweighted adjacency list | V=50000, E=... | Traversal / distances | 1.53433  ms |
| int | bfs_100000.txt | Unweighted adjacency list | V=100000, E=... | Traversal / distances | 2.02792 ms | 
| int | dfs_10.txt | Unweighted adjacency list | V=10, E=14 | Traversal | 0.001625 ms | 
| int | dfs_100.txt | Unweighted adjacency list | V=100, E=... | Traversal | 0.003708 ms |
| int | dfs_10000.txt | Unweighted adjacency list | V=10000, E=... | Traversal | 0.229416 ms |
| int | dfs_50000.txt | Unweighted adjacency list | V=50000, E=... | Traversal | 1.54638 ms |
| int | dfs_100000.txt | Unweighted adjacency list | V=100000, E=... | Traversal | 2.31192 ms |
| int | sssp_10.txt | Positive-weighted adjacency list | V=10, E=14 | Shortest distances | 0.001083 ms | 
| int | sssp_100.txt | Positive-weighted adjacency list | V=100, E=... | Shortest distances | 0.008167 ms | 
| int | sssp_10000.txt | Positive-weighted adjacency list | V=10000, E=... | Shortest distances |0.667083  ms | 
| int | sssp_50000.txt | Positive-weighted adjacency list | V=50000, E=... | Shortest distances |  5.95854 ms | 
| int | sssp_100000.txt | Positive-weighted adjacency list | V=100000, E=... | Shortest distances | 8.69542 ms |
